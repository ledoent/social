 ...
 * the message cannot be drawn with the component the cards use: the widget
 * wires the HTML it receives instead. What "cut" means -- how it is
    ...
    setup() {
        ...
        useEffect(
            (element, value) => {
                ...
                return this._setupMessages(element);
            },
